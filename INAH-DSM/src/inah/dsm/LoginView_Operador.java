 ...
 * @author dokxo
 */
public class LoginView_Operador extends javax.swing.JFrame {

    /**
     * Creates new form LoginView
     */
    public LoginView_Operador () {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginView_Operador .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginView_Operador().setVisible(true);
            }
        });
    }
